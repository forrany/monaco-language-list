...
testTokenization('tcl', [
    ...
    [{
            line: 'set var 1',
            tokens: [
                { startIndex: 0, type: 'keyword.flow.tcl' },
                { startIndex: 3, type: 'source.tcl' },
                { startIndex: 4, type: 'type.tcl' },
    ...
    [{
            ...
            tokens: [
                ...
                { startIndex: 5, type: 'type.tcl' },
                { startIndex: 9, type: 'white.tcl' },
                { startIndex: 10, type: 'delimiter.curly.tcl' },
                { startIndex: 11, type: 'operator.scss.tcl' },
                { startIndex: 12, type: 'white.tcl' },
                { startIndex: 13, type: 'operator.scss.tcl' },
